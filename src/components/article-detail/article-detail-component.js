...
export const updateArticleDetail = ({ id,title, img, video, articleText,authorname,authorprofileImg,caption} =
    ...
    articleDetail.innerHTML = `
        <div class="col-10 mx-auto">
                ...
                <p><a title="back" class="back" href='javascript:history.back()'><- Go Back</a></p>
