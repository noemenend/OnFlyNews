...
export const updateArticleDetail = ({ id, title, img, video, articleText, authorname, authorprofileImg, caption } = { title: 'No title', img: 'http://placehold.it/750x300', articleSummary: 'No article' }) => {
