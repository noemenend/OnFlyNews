...
export const createArticle= ({ id,title, img, video, articleSummary,authorname,authorprofileImg,caption, numComments} = { title: 'No title', img: 'http://placehold.it/750x300', articleSummary:'No article' }) => {
